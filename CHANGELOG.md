...
- Insert `/dbt` resources for Silver/Gold layers ETL pipelines;
- Folder `/scripts` to help deployment and local configurations;
- Create `/src/data` features to fetch and extract **properties** data and manage the first ETL steps with cloud resources;
